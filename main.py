...
def lst_doc():
    ...
    l=["Dr.John","Dr.Paul","Dr.James","Dr.Khan","Dr.Dre","Dr.slim","Dr.Sidharth","Dr.Mark","Dr.Will","Dr.Dolittle",'Dr.Irfan','Dr.Jonas',
       'Dr. Sanjay','Dr. Shahid']
...
def ser_avail():
    ...
    l5=Label(root5,text='To avail any of these please contact on our no.:- 7042803654')
    l5.place(x=20,y=240)
...
root=Tk()
label=Label(root,text="JOHN'S HOSPITAL MANAGEMENT",font="arial 40 bold",bg='DarkGoldenrod1')
b1=Button(text="Registration",font="arial 20 bold",bg='DeepSkyBlue3',command=register)
b2=Button(text="Appointment",font="arial 20 bold",bg='DeepSkyBlue3',command=apoint)
b3=Button(text="List of Doctors",font="arial 20 bold",bg='DeepSkyBlue3',command=lst_doc)
b4=Button(text="Services available",font='arial 20 bold',bg='DeepSkyBlue3',command=ser_avail)
b7=Button(text="View data",font='arial 20 bold',bg='DeepSkyBlue3',command=search_data)
b5=Button(text="Modify existing data",font='arial 20 bold',bg='DeepSkyBlue3',command=mod_sub)
b6=Button(text="Exit",font='arial 20 bold',command=root.destroy,bg='brown3')
label.pack()
